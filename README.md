...
4. [⚙️ Step 2 — Install AWS CLI](#step-2--install-aws-cli)
5. [🔐 Step 3 — Configure AWS Authentication](#-step-3--configure-aws-authentication)
6. [📝 Step 4 — Create the AWS Resource Tracker Shell Script](#-step-4--create-the-aws-resource-tracker-shell-script)
7. [⏰ Step 5 — Automate the Report Using Cron Job](#step-5--automate-the-report-using-cron-job)
8. [🛠️ Technologies Used](#️-technologies-used)
9. [🎯 What I Learned](#-what-i-learned)
10. [🔮 Future Improvements](#-future-improvements)
11. [📌 Future Automation Flow](#-future-automation-flow)
12. [👩‍💻 Author](#-author)
